...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-12 mt-lg-1 mt-4">
                            <div class="card">
                                ...
                                <div class="card-body pt-0 p-3 text-center">
                                    <h6 class="text-center text-primary  mb-0">{{trans('employer::employer.walletBalanceEmployerAccount')}}</h6>
                        ...
                        <div class="col-lg-4 col-sm-12 mt-lg-1 mt-4">
                            <div class="card">
                                ...
                                <div class="card-body pt-0 p-3 text-center">
                                    <h6 class="text-center text-warning  mb-0">{{trans('employer::employer.fees_per_transfer_wallet_balance')}}</h6>
                                    <hr class="horizontal dark my-3">
                        ...
                        <div class="col-lg-4 col-sm-12 mt-lg-1 mt-4">
                            <div class="card">
                                ...
                                <div class="card-body pt-0 p-3 text-center">
                                    <h6 class="text-center text-info  mb-0">{{trans('employer::employer.walletBalanceWorkerAccount')}}</h6>
                                    <hr class="horizontal dark my-3">
        ...
        <form method="POST" action="{{route('employer.switch.account.to.worker.with.transfer.wallet.balance')}}"
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <div class="numbers mb-2">
                                        <p class="text-sm mb-0 text-capitalize  font-weight-bold">{{trans('employer::employer.amountYouWantTransferredToWorkerWallet')}}</p>
                                    </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="numbers mb-2">
                                        <p class="text-sm mb-0 text-capitalize  font-weight-bold">{{trans('employer::employer.amountTransferredAfterFees')}}</p>
                                    </div>
                                    ...
                                    <input class="multisteps-form__input form-control"
                                           ...
                                           placeholder="{{trans('employer::employer.amountTransferredAfterFees')}}"
                                           onfocus="focused(this)"
                                           onfocusout="defocused(this)"
                                           disabled
                                    >
            ...
            <div class="row mt-4">
                <div class="button-row ">
                    <button type="submit"
                            class="btn btn-success btn-lg w-100   mb-2">{{trans('employer::employer.SwitchAccountAndTransferWalletBtn')}}</button>
                </div>
                <div class="button-row ">
                    <a href="{{route('employer.show.switching.account.history')}}"
                       class="btn btn-dark btn-lg w-100   mb-2">{{trans('employer::employer.back')}}</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <script>
        $(document).on('input', '#amount_input', function () {
            ...
            document.getElementById("employer_wallet_balance").innerHTML = Number((EmployerWalletBalance - Amount).toFixed(2)) + " $";
            document.getElementById("worker_wallet_balance").innerHTML = Number((WorkerWalletBalance + (Amount - (Amount * fees / 100))).toFixed(2)) + " $";
