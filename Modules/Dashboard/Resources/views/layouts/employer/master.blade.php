...
<div class="side_menu" >
    <ul class="">
        ...
        <li class="side_menu_item">
            <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link nav-text collapsed" aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                ...
                <ul class="nav ms-4 ps-3">
                    ...
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/tasks/pending-tasks">
                            <span class="sidenav-normal"> {{trans('employer::employer.taskInPendingToAcceptAdmin')}} </span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-text " href="http://127.0.0.1:8001/panel/employer/tasks/not-published-tasks">
        ...
        <li class="side_menu_item">
            <a data-bs-toggle="collapse" href="#FinancialAffairs" class="nav-link nav-text collapsed" aria-controls="FinancialAffairs" role="button" aria-expanded="false">
            ...
            <div class="collapse" id="FinancialAffairs" style="">
                <ul class="nav ms-4 ps-3">
                    ...
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/financial-affairs/wages-and-costs">
                            <span class="sidenav-normal"> {{trans('employer::employer.WagesAndCosts')}} </span>
                        </a>
                    </li>

                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/management-affairs/switch-account/employer-to-worker-with-transfer-wallet-balance">
                            <span class="sidenav-normal"> {{trans('employer::employer.TransferEmployerWalletBalanceToWorker')}} </span>
                        </a>
                    </li>
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/financial-affairs/wallet-history">
        ...
        <li class="side_menu_item">
            <a data-bs-toggle="collapse" href="#ManagementSection" class="nav-link nav-text" aria-controls="ManagementSection" role="button" aria-expanded="">
            ...
            <div class="collapse" id="ManagementSection" style="">
                <ul class="nav ms-4 ps-3">
                    ...
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/management-affairs/switch-account/history">
                            <span class="sidenav-normal">  {{trans('employer::employer.switchingAccountHistory')}}</span>
                        </a>
                    </li>
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/management-affairs/show-privilege-history">
                            <span class="sidenav-normal">  {{trans('employer::employer.PrivilegesHistory')}} </span>
                        </a>
                    </li>
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/management-affairs/rule-of-privileges">
        ...
        <li class="side_menu_item ">
            <a data-bs-toggle="collapse" href="#EmployerSupport" class="nav-link nav-text" aria-controls="EmployerSupport" role="button" aria-expanded="">
        ...
        <li class="side_menu_item">
            <a data-bs-toggle="collapse" href="#AppLanguage" class="nav-link nav-text" aria-controls="AppLanguage" role="button" aria-expanded="">
            ...
            <div class="collapse" id="AppLanguage" style="">
                <ul class="nav ms-4 ps-3">
                    <li class="">
                        <a class="nav-link nav-text active-select-nav" href="http://127.0.0.1:8001/panel/employer/settings/change-app-language/ar">
                            <span class="sidenav-normal"> العربية  </span>
                        </a>
                    </li>
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/settings/change-app-language/en">
        ...
        <li class="side_menu_item">
            <a data-bs-toggle="collapse" href="#SelectedCurrency" class="nav-link nav-text" aria-controls="SelectedCurrency" role="button" aria-expanded="">
                <i class="fa fa-usd"></i>
            ...
            <div class="collapse " id="SelectedCurrency" style="">
                <ul class="nav ms-4 ps-3">
                    <li class="">
                        <a class="nav-link nav-text active-select-nav" href="http://127.0.0.1:8001/panel/employer/settings/change-app-currency/USD">
                            <span class="sidenav-normal"> دولار أمريكي  </span>

                        </a>
                    </li>
                    <li class="">
                        <a class="nav-link nav-text" href="http://127.0.0.1:8001/panel/employer/settings/change-app-currency/EGP">
