...
@section('content')
    ...
    <div class="row mt-2">
        ...
        $current_currency = \Modules\Currency\Entities\Currency::withoutTrashed()
            ...
            ->first();
        ?>
        <div class="col-lg-9 col-md-9 col-sm-12 col-12" id="totalTasks">
                ...
                @if (isset($specialToNormalAccessTasks) and count($specialToNormalAccessTasks) > 0)
                    @foreach ($specialToNormalAccessTasks as $task)
                        @if ($task->special_access == 'true')
                            <div class="row col-12 gx-4 position-relative task-featured-preview-border-gradient text-dark py-2 border-radius-xl justify-content-lg-start justify-content-md-start justify-content-center mt-1">

                                <div class="col-md-1 col-6 d-flex text-start">
                                    <img class="featured-task col-md-8 " data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="{{ trans('worker::task.ThisFutcheredTasks') }}" data-container="body" data-animation="true"
                                        {{--src="{{asset('assets/img/default/FutcheredTasks.png')}}" --}}
                                        src="{{ asset('assets/img/default/FutcheredTasks2.png') }}" width="40%" height="80%" alt="">
                                </div>
                        @else

                                <div class="col-md-12 col-sm-12 gx-4 task-normal-preview-border-gradient text-dark py-2 border-radius-xl justify-content-lg-start justify-content-md-start justify-content-center mt-1">
                        @endif
                        {{-- task items --}}
                        @if ($task->special_access == 'true')
                        ...
                        @endif
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                ...
                                <div class="d-flex flex-wrap mt-2 mb-1 justify-content-center justify-content-md-start justify-content-lg-start">
                                    <div class="d-flex align-items-center flex-wrap text-dark border-radius-2xl text-lg mt-2 mt-lg-0 mt-md-2 col-12 col-md-4">
