        ...
        <div class="col-lg-3 col-md-3 col-12 mb-lg-0 mb-md-3 mb-3">
            <div class="col-12  mt-2 mt-lg-2">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu w-100 text-lg task-category-filter-buttons"
                        ...
                        <li><a class="dropdown-item"
                               data-category-name="AllCategoryFilterBtn"
                               data-category-type="all">{{trans('worker::task.AllTaskCategories')}}</a>
                        </li>
                        @foreach($categories as $category)
                            @if(app()->getLocale()=="ar")
                                <li><a class="dropdown-item"
                                       data-category-name="{{$category->ar_title}}"
            ...
            <div class="col-12  mt-2 mt-lg-1">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu w-100 text-lg task-country-filter-buttons"
                        aria-labelledby="TaskCountryFilter">
                        <li><a class="dropdown-item"
                               data-country-name="AllCountryFilterBtn"
                            ...
                            @if(app()->getLocale()=="ar")
                                <li>
                                    <a class="dropdown-item"
                                       data-country-name="{{$country->ar_name}}"
                ...
                <div class="card bg-gradient-primary text-white">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-9">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">{{trans('worker::task.TotalTaskCostRange')}}</p>

                                    <div class="d-flex mt-1">
                                        <span class="mx-1"><output id="rangevalue">{{$min_total_costs}}</output></span>
                                        <input class="form-range " id="TotalCostRange" type="range"
                                               min="{{$min_total_costs}}" max="{{$max_total_costs}}"
                                               value="{{$max_total_costs}}"
                ...
                @if(isset($specialToNormalAccessTasks) and count( $specialToNormalAccessTasks)>0)
                    @foreach($specialToNormalAccessTasks as $task)
                        @if($task->special_access == "true")
                            <div
                                class="row gx-4 position-relative task-featured-preview-border-gradient text-dark  py-2 border-radius-xl justify-content-lg-start justify-content-md-start justify-content-center mt-1  ">
                                <div class=" ">
                                    <img class="featured-task "
                                         data-bs-toggle="tooltip"
                                         data-bs-placement="top"
                                         title="{{trans('worker::task.ThisFutcheredTasks')}}"
                                         data-container="body"
                                         data-animation="true"
                                         {{--                                         src="{{asset('assets/img/default/FutcheredTasks.png')}}"--}}
                                         src="{{asset('assets/img/default/FutcheredTasks2.png')}}"
                                         width="" alt="">
                                </div>
                                @else
                                    <div
                                        ...
                                        <div class="row align-items-center justify-content-between">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <span
                                                            ...
                                                            <span
                                                                class="text-xxs">{{auth()->user()->current_currency}}</span>
                                                        </span>
                                                    </div>
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-primary">{{$task->approved_workers}} </span>
                                                    </div>
                                                    <div
                                                        ...
                                                        <span class="text-dark" id="LimitTaskCountries">
                                                                 <div class="avatar-group">
                                                                     @if(count($task->countries)<=6)
                                                                         @for($i=0;$i<count($task->countries);$i++ )
                                                                             <a href="javascript:;"
                                                                                ...
                                                                                @if(app()->getLocale()=="ar")
                                                                                title="{{$task->countries[$i]->country->ar_name}}"
                                                                                @else
                                                                                title="{{$task->countries[$i]->country->name}}"
                                                                                @endif
                                                                                data-container="body"
                                                                                data-animation="true">
                                                                     ...
                                                                     @elseif(count($task->countries) == count($countries))
                                                                         <span
                                                                             class="mx-3 text-primary">  {{trans('worker::task.AllCountries')}}</span>
                                            ...
                                            <div
                                                class="col-lg-2 col-md-12 col-sm-12  text-lg-start text-center   mt-3 ">
                                                <a href="{{route('worker.show.task.details',[$task->id,$task->task_number])}}"
                                                   class="btn btn-sm btn-secondary "
                                                   style="padding-top: 20px;padding-bottom: 20px"> {{trans('worker::task.showTaskDetailsBtn')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                                        <h4 class="bg-gradient-primary border-radius-2xl p-6 text-center text-white text-lg"> {{trans('worker::task.NoTaskFound')}} </h4>
                                    @endif
                ...
                <div class="row mt-2 d-none" id="NoResulte">
                    <div
                        ...
                        <div class="row align-items-center">
                            <div class="col-12">
                                <div
                                    class="nav-wrapper text-lg text-center text-gradient text-dark position-relative end-0">
                        ...
                        success: function (response) {
                            ...
                            if (response.length > 0) {
                                ...
                                response.forEach(function (tasks) {
                                    ...
                                    var TaskFutchered = "<div class='row gx-4 position-relative task-featured-preview-border-gradient text-dark  py-2 border-radius-xl justify-content-lg-start justify-content-md-start justify-content-center mt-1 '>" +
                                        '<div class=" ">' +
                                        '<img src="/assets/img/default/FutcheredTasks2.png' + '"' + 'alt="special_access_task" width=""  class="featured-task">' +
                                        '</div>' +
                                        '<div class="row align-items-center justify-content-between">' + '<div class="col-lg-1 col-md-12 col-12   text-center  mx-lg-4 mx-md-4 mx-0">'
                                        + '<div class="avatar avatar-xl position-relative">' +
                                        '<img src="/storage/' + tasks.category.image + '"' + 'alt="profile_image" class="w-100 border-radius-lg">' + '</div> </div>' +
                                        '<div class="col-lg-8 col-md-12 col-sm-12">' +
                                        '<div class="nav-wrapper position-relative end-0">' +
                                        '<h5 class="mb-1 mt-1 text-dark">' +
                                        '<span class="text-xs text-info">' + moment(tasks.created_at).format('YYYY-MM-DD/HH:mm') + '</span>' + tasks.title + '</h5>' +
                                        '<p class="mb-1 mt-1 text-justify">' + tasks.description.slice(0, 70) + "..." + '</p>' +
                                        '</div>'
                                        + '<div class="col-auto d-flex flex-wrap mt-2 mb-1 justify-content-center justify-content-md-start justify-content-lg-start">' +
                                        '<div class="col-3 d-flex  align-items-center flex-wrap  text-dark   border-radius-2xl text-lg mt-2 mt-lg-0 mt-md-2">' +
                                        '<i class="fa fa-dollar text-success  text-1-5-rem "></i>' +
                                        '<span class="text-dark mx-2  {{$current_currency->rate > 10  ? 'font-size-16' : ''}}">' +(Math.round(tasks.total_cost * {{$current_currency->rate}} * 100) / 100).toFixed(1)
                                        + '<span class="text-xxs">' + ' {{$current_currency->en_name}} ' + '</span>' +
                                        '</span>' +
                                        '</div>' +
                                        ...
                                        '<a href="' + 'https://arabworkers.com/app/panel/worker/tasks/task-details/' + tasks.id + '/' + tasks.task_number + '"' + 'class="btn btn-sm btn-secondary " style="padding-top: 20px;padding-bottom: 20px"> {{trans('worker::task.showTaskDetailsBtn')}}</a>' +
                                        '</div>' +
                                        '</div>' +
                                        '</div>';

                                    var TaskNormal = "<div class='row gx-4 task-normal-preview-border-gradient text-dark  py-2 border-radius-xl justify-content-lg-start justify-content-md-start justify-content-center mt-1 '>" +
                                        '<div class="row align-items-center justify-content-between">' + '<div class="col-lg-1 col-md-12 col-12   text-center  mx-lg-4 mx-md-4 mx-0">'
                                        + '<div class="avatar avatar-xl position-relative">' +
                                        '<img src="/storage/' + tasks.category.image + '"' + 'alt="profile_image" class="w-100 border-radius-lg">' + '</div> </div>' +
                                        '<div class="col-lg-8 col-md-12 col-sm-12">' +
                                        ...
                                        '</span>' +
                                        '</div>' +
                                        '<div class="col-2 d-flex  align-items-center flex-wrap p-2 text-dark  border-radius-2xl text-lg mx-2 mt-2 mt-lg-0 mt-md-2">' +
                                        '<i class="fa fa-code-fork text-secondary text-lg mx-2"></i>' +
                                        '<span class="text-dark">' + tasks.total_worker_limit + '/' + '</span>' +
                                        '<span class="text-primary">' + tasks.approved_workers + '</span>' +
                                        '</div>' +
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.sort-buttons a').click(function () {
                    ...
                    switch (sortType) {
                        case 'oldest':
                            document.getElementById('SortTypeText').innerHTML = '{{ trans('worker::task.TasksSortedByOldest') }}';
                            break;
                        case 'newest':
                            document.getElementById('SortTypeText').innerHTML = '{{trans('worker::task.TasksSortedByNewest')}}';
                            break;
                        case 'cheapest':
                            document.getElementById('SortTypeText').innerHTML = '{{trans('worker::task.TasksSortedByCheapest')}}';
                            break;
                        case 'expensive':
                            document.getElementById('SortTypeText').innerHTML = '{{trans('worker::task.TasksSortedByExpensive')}}';
                            break;
                        case 'workerAccept':
                            document.getElementById('SortTypeText').innerHTML = '{{trans('worker::task.TasksSortedByWorkerAccept')}}';
                            break;
                        case 'originalArrangement':
                            document.getElementById('SortTypeText').innerHTML = '{{trans('worker::task.TasksSortedByOriginalArrangement')}}';
                            break;
                    }
                    if (sortType == "originalArrangement") {
                        ...
                        $.ajax({
                            url: '{{ route("worker.ajax.task.sort", ["sortType" => ":sortType"]) }}'.replace(':sortType', sortType),
                            success: function (response) {
                                TotalTask.classList.add('d-none');
                                document.getElementById('tasks-list').classList.remove('d-none');
                                if (response.length > 0) {
            ...
            $(document).ready(function () {
                ...
                $('.task-category-filter-buttons a').click(function () {
                    ...
                    if (categoryName == "AllCategoryFilterBtn") {
                        document.getElementById('TaskCategoryFilterText').innerHTML = '{{ trans('worker::task.AllCategoryFilterBtn') }}';
                    } else {
                        document.getElementById('TaskCategoryFilterText').innerHTML = '{{ trans('worker::task.TaskShowedByCategoryName') }}' + categoryName;
                    }
                    if (categoryType == "all") {
                        TotalTask.classList.remove('d-none');
                        document.getElementById('tasks-list').classList.add('d-none');
                        ...
                        $.ajax({
                            url: '{{ route("worker.ajax.task.categories", ["categoryType" => ":categoryType"]) }}'.replace(':categoryType', categoryType),
                            success: function (response) {
                                TotalTask.classList.add('d-none');
                                document.getElementById('tasks-list').classList.remove('d-none');
                                if (response.length > 0) {
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.task-level-buttons a').click(function () {
                    ...
                    switch (levelType) {
                        case 'professional':
                            document.getElementById('TaskLevelText').innerHTML = '{{ trans('worker::task.onlyProfessionalTasks') }}';
                            break;

                        case 'not_professional':
                            document.getElementById('TaskLevelText').innerHTML = '{{ trans('worker::task.onlyNotProfessionalTasks') }}';
                            break;
                        case 'all_level':
                            document.getElementById('TaskLevelText').innerHTML = '{{ trans('worker::task.AllLevelTasks') }}';
                            break;
                    }
                    if (levelType == "all_level") {
                        ...
                        $.ajax({
                            url: '{{ route("worker.ajax.task.level", ["levelType" => ":levelType"]) }}'.replace(':levelType', levelType),
                            success: function (response) {
                                TotalTask.classList.add('d-none');
                                document.getElementById('tasks-list').classList.remove('d-none');
                                if (response.length > 0) {
            ...
            $(document).ready(function () {
                ...
                $('.task-country-filter-buttons a').click(function () {
                    ...
                    if (countryName == "AllCountryFilterBtn") {
                        document.getElementById('TaskCountryFilterText').innerHTML = '{{ trans('worker::task.AllCountryFilterBtn') }}';
                    } else {
                        document.getElementById('TaskCountryFilterText').innerHTML = '{{ trans('worker::task.TaskShowedByCountryName') }}' + countryName;
                    }
                    if (countryType == "AllCountryFilterBtn") {
                        ...
                        $.ajax({
                            url: '{{ route("worker.ajax.task.country", ["countryType" => ":countryType"]) }}'.replace(':countryType', countryType),
                            success: function (response) {
