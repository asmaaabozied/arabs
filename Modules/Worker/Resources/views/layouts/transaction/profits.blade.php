...
{{--                                    <h6 class="text-center mb-0">{{trans('worker::worker.paypal_account')}}</h6>--}}
{{--                                    <hr class="horizontal dark my-3">--}}
{{--                                    <h5 class="mb-0 text-primary">{{auth()->user()->paypal_account??trans('worker::worker.not_paypal_account_set')}}</h5>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-sm-12 mt-lg-1 mt-4">--}}
...
{{--                                </div>--}}
{{--                                <div class="card-body pt-0 p-3 text-center">--}}
{{--                                    <h6 class="text-center mb-0">{{trans('worker::worker.pendingProfits')}}</h6>--}}
{{--                                    <hr class="horizontal dark my-3">--}}
...
{{--                                </div>--}}
{{--                                <div class="card-body pt-0 p-3 text-center">--}}
{{--                                    <h6 class="text-center mb-0">{{trans('worker::worker.acceptedProfits')}}</h6>--}}
{{--                                    <hr class="horizontal dark my-3">--}}
...
{{--                                </div>--}}
{{--                                <div class="card-body pt-0 p-3 text-center">--}}
{{--                                    <h6 class="text-center mb-0">{{trans('worker::worker.walletBalance')}}</h6>--}}
{{--                                    <hr class="horizontal dark my-3">--}}
