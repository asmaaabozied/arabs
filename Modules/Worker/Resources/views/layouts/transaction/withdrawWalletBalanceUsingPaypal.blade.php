            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <div class="numbers mx-3">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">{{trans('worker::worker.paypal_account')}} ({{trans('worker::worker.paypal_fees') .$fees_per_withdraw_wallet_using_paypal}}%)</p>
